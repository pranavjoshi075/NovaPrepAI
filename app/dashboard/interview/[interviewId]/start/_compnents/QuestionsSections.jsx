...
function QuestionsSections({activeQuestionIndex,mockInterViewQuestion}) {
        console.log("mockInterViewQuestion (full):", mockInterViewQuestion);
    console.log("Type of mockInterViewQuestion:", typeof mockInterViewQuestion);
    console.log(
        "Object.keys:",
        mockInterViewQuestion ? Object.keys(mockInterViewQuestion) : "undefined"
    );
  ...
  return mockInterViewQuestion&&(
    <div className='p-5 border rounded-lg my-10'>
        ...
        {mockInterViewQuestion?.[activeQuestionIndex]?.question ? (
            ...
            <h2 className='my-5 text-sm md:text-lg text-gray-500 italic'>
                Loading question or index out of range.
            </h2>
        )}
