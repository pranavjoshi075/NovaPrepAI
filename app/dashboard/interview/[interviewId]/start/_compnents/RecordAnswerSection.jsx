...
function RecordAnswerSection({ activeQuestionIndex, mockInterViewQuestion,interviewData }) {
    ...
    if (isRecording) {
      ...
      try {
        ...
        if (err.name === "InvalidStateError") {
          toast("Speech recognition is already active.");
        } else {
          toast("Error starting speech recognition.");
          console.error(err);
        }
      }
    }
  ...
  const UpdateUserAnswerInDb=async()=>{
    if (
      ...
      console.warn("Question data not loaded or index is invalid");
      return;
    }
    ...
    console.log("Saving feedback under mockId:", interviewData?.mockId);
